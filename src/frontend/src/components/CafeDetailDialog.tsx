...
export default function CafeDetailDialog({
  cafe,
  open,
  onOpenChange,
}: CafeDetailDialogProps) {
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription className="flex items-center gap-1">
            ...
            {cafe.location.latitude.toFixed(4)},{" "}
            {cafe.location.longitude.toFixed(4)}
          </DialogDescription>
        </DialogHeader>
              ...
              <div className="rounded-lg border bg-white p-6">
                <div className="space-y-2 text-center">
                  ...
                  <p className="text-xs text-gray-600">
                    Show this code at the cafe
                  </p>
                </div>
              </div>
            </div>
            <p className="text-center text-sm text-muted-foreground">
              Present this reservation code at the cafe to redeem your free cup.
              You'll have 24 hours to submit your cupping form after redemption.
            </p>
          ...
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <Badge
                  variant={
                    Number(cafe.availableFreeCups) > 0 ? "default" : "outline"
                  }
                >
                        ...
                        <div className="flex items-start justify-between gap-4">
                          ...
                          <Button
                            ...
                            disabled={
                              ...
                              Number(cafe.availableFreeCups) === 0
                            }
                          >
