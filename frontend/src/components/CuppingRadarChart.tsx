...
export default function CuppingRadarChart({ scores, title, showLegend = true }: CuppingRadarChartProps) {
  const data = [
        ...
        <RadarChart data={data}>
          <defs>
            <linearGradient id="coffeeGradient" x1="0" y1="0" x2="0" y2="1">
              ...
              <stop offset="100%" stopColor="oklch(var(--accent))" stopOpacity={0.3} />
            </linearGradient>
          </defs>
          <PolarGrid 
